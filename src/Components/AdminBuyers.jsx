            ...
            <div className="admin__products admin__userVerify">
                ...
                >
                    <div className="adminModal admin__userModalHeader">
                        <h1 className="orderModal__heading">New Buyer Details</h1>
                        <button
        ...
        return (
            <div className="admin">
                ...
                <div className="admin__navbar extraNavbar">
                    ...
                    <Link to='/buyer/admin/buyers' className="admin__navbarOption active"><h4>All Buyers</h4></Link>
                ...
                <div className="admin__mainPage">
                    <h4 className="admin__heading">New Buyer Details</h4>
                    {data && data.map((data) =>
                        data.approved == 1 ? data.user_type === "Buyer" ?
                            (
